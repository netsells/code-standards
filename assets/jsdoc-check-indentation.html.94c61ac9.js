import{_ as o,r as e,o as u,c as r,a as n,d as a,w as c,b as s,e as d}from"./app.4f0f8968.js";const p={},m={id:"jsdoc-check-indentation",tabindex:"-1"},k=n("a",{class:"header-anchor",href:"#jsdoc-check-indentation","aria-hidden":"true"},"#",-1),v=d(`<p>Reports invalid padding inside JSDoc blocks.</p><p>Ignores parts enclosed in Markdown &quot;code block&quot;&#39;s. For example, the following description is not reported:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * Some description:
 * \`\`\`html
 * &lt;section&gt;
 *   &lt;title&gt;test&lt;/title&gt;
